...
const approach = [
  {
    number: "01",
                  image: "/counsellor/student-story-01.png",
  ...
  {
    number: "02",
                  image: "/counsellor/student-story-02.png",
  ...
  {
    number: "03",
                  image: "/counsellor/student-story-03.png",
  ...
  {
    number: "04",
                  image: "/counsellor/student-story-04.png",
        ...
        <div className="mx-auto max-w-[1700px] px-6 py-24 sm:px-10 lg:px-16 lg:py-32 xl:px-24">
          <div className="grid gap-14 lg:grid-cols-[0.82fr_1.18fr] lg:items-start lg:gap-20">
            <div>
              ...
              <h2 className="mt-7 max-w-2xl text-5xl font-medium leading-[0.94] tracking-[-0.045em] sm:text-6xl lg:text-[5.2rem]">
                Every number represents a person.
              </h2>

              <p className="mt-8 max-w-md text-sm leading-6 text-white/50 sm:text-base">
                Behind every application is a student with a goal, a decision
                to make and a future they are preparing for.
              </p>
              ...
              <div className="mt-12 overflow-hidden border border-white/10">
                <div className="relative aspect-[4/3]">
                  <img
                    ...
                    className="absolute inset-0 h-full w-full object-cover object-center grayscale-[15%] transition duration-700 hover:scale-[1.02]"
                  />
                  ...
                  <div className="absolute bottom-0 left-0 p-6 sm:p-8">
                    ...
                    <p className="mt-3 max-w-xs text-sm leading-6 text-white/80">
                      Example visual — replace with an approved student story
                      when ready.
                    </p>
                  </div>
                </div>
              ...
              {[
                {
                  ...
                  text: "Example story placeholder for a student's goals, choices and preparation.",
                },
                {
                  number: "02",
                  image: "/counsellor/student-story-02.png",
                  ...
                  text: "Example story placeholder for the preparation journey before an interview.",
                },
                {
                  number: "03",
                  image: "/counsellor/student-story-03.png",
                  ...
                  text: "Example story placeholder for how guidance helped clarify the next step.",
                },
                {
                  number: "04",
                  image: "/counsellor/student-story-04.png",
                  ...
                  text: "Example story placeholder for a student's journey and future plans.",
                },
              ].map((story) => (
                <article
                  key={story.number}
                  className="group border-t border-white/10 py-8 sm:py-10"
                >
                  <div className="relative mb-7 aspect-[4/3] overflow-hidden"><img src={story.image} alt="" className="h-full w-full object-cover transition duration-700 group-hover:scale-[1.03]" /></div><div className="flex items-start justify-between gap-6">
                    <span className="text-[9px] font-semibold tracking-[0.22em] text-white/30">
                      {story.number}
                    </span>

                    <span className="text-lg text-white/25 transition duration-300 group-hover:translate-x-1 group-hover:text-white/70">
                      ↗
                    </span>
                  </div>

                  <h3 className="mt-16 max-w-xs text-xl font-medium leading-tight tracking-[-0.02em] text-white/90 sm:text-2xl">
                    {story.title}
                  </h3>
